This skill provides guidance for AI agents working with VTEX FastStore Implementation & Customization. Apply these constraints and patterns when assisting developers with apply when deciding, designing, or implementing faststore theme customizations in src/themes/ or working with design tokens and scss variables. covers global tokens, local component tokens, sass variables, css custom properties, and brandless architecture. use for any visual customization of faststore storefronts that does not require component overrides.
