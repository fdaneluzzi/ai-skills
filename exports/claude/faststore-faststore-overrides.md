This skill provides guidance for AI agents working with VTEX FastStore Implementation & Customization. Apply these constraints and patterns when assisting developers with apply when deciding, designing, or implementing faststore component overrides in src/components/overrides/. covers getoverriddensection api, component replacement, props overriding, and custom section creation. use for any faststore storefront customization beyond theming that requires changing component behavior or structure.
